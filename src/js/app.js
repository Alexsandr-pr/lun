...
class PlayerCreate {
    ...
    createPlayer(){
        ...
        if(this.positionComand === 0) {
            if(this.positionY >= 99 && this.positionX >= 99 ) {
                div.style.cssText = `left: calc(${this.positionX}% - 78px); top: calc(${this.positionY}% - 50px);`
            } else if(this.positionY >= 99 && this.positionX <= 1){
                div.style.cssText = `left: calc(${this.positionX}% - 0px); top: calc(${this.positionY}% - 50px);`
            }  else if(this.positionY >= 99 ){
                div.style.cssText = `left: calc(${this.positionX}% - 39px); top: calc(${this.positionY}% - 50px);`
            } else if(this.positionY === 0) {
                div.style.cssText = `left: calc(${this.positionX}% - 39px); top: calc(${this.positionY}% - 12px);`
            } else if(this.positionX === 0) {
                div.style.cssText = `left: ${this.positionX}%; top: calc(${this.positionY}% - 50px);`
            } else if(this.positionX >= 99) {
                div.style.cssText = `left: calc(${this.positionX}% - 78px); top: calc(${this.positionY}% - 50px);`
            } else {
                div.style.cssText = `left: calc(${this.positionX}% - 39px); top: calc(${this.positionY}% - 50px);`
            }
            ...
            if(this.positionY >= 99 && this.positionX >= 99 ) {
                div.style.cssText = `left: calc(${this.positionX}% - 78px); bottom: calc(${this.positionY}% - 50px);`
            } else if(this.positionY >= 99 && this.positionX <= 1){
                div.style.cssText = `left: calc(${this.positionX}% - 0px); bottom: calc(${this.positionY}% - 50px);`
            }  else if(this.positionY >= 99 ){
                div.style.cssText = `left: calc(${this.positionX}% - 39px); bottom: calc(${this.positionY}% - 50px);`
            } else if(this.positionY === 0) {
                div.style.cssText = `left: calc(${this.positionX}% - 39px); bottom: calc(${this.positionY}% - 12px);`
            } else if(this.positionX === 0) {
                div.style.cssText = `left: ${this.positionX}%; bottom: calc(${this.positionY}% - 50px);`
            } else if(this.positionX >= 99) {
                div.style.cssText = `left: calc(${this.positionX}% - 78px); bottom: calc(${this.positionY}% - 50px);`
            } else {
                div.style.cssText = `left: calc(${this.positionX}% - 39px); bottom: calc(${this.positionY}% - 50px);`
